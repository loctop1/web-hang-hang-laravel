<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex justify-content-center ">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100 ">
            <a class="navbar-brand brand-logo " href="index.html"><img class="h-100" src={{ asset('admin\images\large.png') }}
                    alt="logo" />LỘC</a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/favicon.png"
                    alt="logo" /></a>
            ...
            <li class="nav-item dropdown me-4">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="notificationDropdown">
                    ...
                    <a class="dropdown-item">
                        ...
                        <div class="item-content">
                            <h6 class="font-weight-normal">Cài đặt chung</h6>
                            <p class="font-weight-light small-text mb-0 text-muted">
                                Tin nhắn riêng
                            </p>
                        </div>
